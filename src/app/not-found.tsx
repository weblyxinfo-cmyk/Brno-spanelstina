  ...
  return (
    <div className="min-h-screen bg-[#FBF9F6] flex items-center justify-center px-6 py-20">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <h1 className="text-6xl sm:text-7xl md:text-8xl font-bold text-[#C41E3A] mb-4">
          Ay caramba!
        </h1>
        ...
        <div className="relative mb-10">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-24 h-24 bg-gradient-to-br from-[#C41E3A] to-[#9E1830] rounded-3xl flex items-center justify-center shadow-lg shadow-[#C41E3A]/30">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="inline-flex items-center gap-1 text-[#C41E3A] hover:text-[#9E1830] font-medium text-sm hover:underline"
              >
